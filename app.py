...
with st.sidebar:
    ...
    age = st.selectbox("Wiek", ['<18', '18-24', '25-34', '34-44', '45-54', '55-64', '>=65'])
    edu_level = st.selectbox("Wykształcenie", ['Podstawowe', 'Średnie', 'Wyższe'])
    fav_animals = st.selectbox("Ulubione zwierzęta", ['Brak ulubionych', 'Psy', 'Koty', 'Inne', 'Psy i koty'])
...
st.metric("Liczba twoich znajpmych", len(same_cluster_df))
